...
DEBUG = True
ALLOWED_HOSTS = ['django-app-oa8b.onrender.com', '127.0.0.1', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.csrf',# thêm
                'ecommece_app.context_processors.customer_visibility',
